...
<head>
	...
	<link rel="shortcut icon" href="{{ asset('asset/images/gt_favicon.png') }}">
	...
	<!--[if lt IE 9]> <script src="{{ asset('asset/js/html5shiv.js') }}"></script> <![endif]-->
</head>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-push-2 text-center">
				...
				<p class="lead">
					Pikachu diablo 3 asians angry birds final week varius le girlfriend in.
					Feel Like a Sir panda blizzard hac mom nerd monday in on nyan cat.
				</p>
	...
	<section class="container space-before">
		...
		<div class="row featurelist space-after">
			<div class="col-md-5 col-sm-6 col-md-push-1 ">
				<img class="img-feature img-responsive" src="{{  asset('asset/images/screen1.png') }}" alt="Sample image">
			</div>
		...
		<div class="row featurelist space-after">
			<div class="col-md-5 col-sm-6 col-sm-push-6">
				<img class="img-feature img-responsive" src="{{asset('asset/images/screen2.png')}}" alt="Sample image">
			</div>
		...
		<div class="row featurelist space-after">
			<div class="col-md-5 col-sm-6 col-md-push-1 col-sm-6">
				<img class="img-feature img-responsive" src="{{ asset('asset/images/screen3.png') }}" alt="Sample image">
			</div>
			<div class="col-md-5 col-md-push-1 col-sm-6">
