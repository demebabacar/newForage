  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="">Voulez-vous bien supprimer!!!</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary"><i class="fas fa-times">&nbsp;delete</i> Valider</button>
      </div>
    </div>
  </div>
</form >
      ...
      $(document).ready(function () {
          $('#table-clients').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        '<div class="btn btn-danger btn-delete-client" data-href='+url_d+'><i class="material-icons">delete</i></div>';
                        },
                        "targets": 4
                        },
                    // {
          ...
          $("#table-clients").off('click','.btn-delete-client').on('click','.btn-delete-client',function(){
            ...
            $("#form-delete-client").attr('action',href); // cela permet de similer la formulaire avec suppression du client choisi
